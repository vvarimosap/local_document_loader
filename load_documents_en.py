...
db = Chroma(persist_directory="./chroma_db_en", embedding_function=embeddings)
...
query = "Who are parties listed in example order Form for SAP Cloud Services and what are their addresses?"
